...
return {
	...
	},
	{
		...
		opts = {
			...
			-- super-tab makes the tab useful to go over with the selection ('default' use C-y)
			...
			completion = {
				menu = { border = "single" },
				documentation = { auto_show = true, window = { border = "single" } }, -- show documentation after selecting the functionality
			},
